...
Everything ships synthesized, generated by `scripts/gen-sfx.sh` with ffmpeg, except
`typing-effect.mp3`, a copyright-free recording. Nothing is licensed, so **a rendered
video carries no third-party audio rights**.
